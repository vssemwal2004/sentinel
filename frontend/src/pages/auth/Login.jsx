      ...
      <div className="relative z-10 w-full max-w-6xl mx-4">
        <div className="bg-gradient-to-br from-slate-900/95 via-blue-950/90 to-indigo-950/95 backdrop-blur-xl rounded-3xl md:rounded-[2.5rem] border-2 md:border-4 border-sky-600/50 shadow-2xl overflow-hidden">
          <div className="grid lg:grid-cols-2 min-h-[80vh] md:min-h-[600px]">
            ...
            {/* Left Panel - Enhanced Bus Animation */}
                ...
                <div className="bus-container animate-bus-drive">
                  <svg viewBox="0 0 400 300" className="w-full h-auto drop-shadow-2xl">
                    ...
                    <g className="animate-bus-bounce">
                      ...
                      {/* Enhanced Windows with Reflection */}
              ...
              <div className="text-center relative z-10 px-4">
                ...
                <div className="space-y-3 text-sky-100/80">
                  ...
                  <p className="text-sm md:text-base max-w-md mx-auto leading-relaxed">
                    Experience the future of public transportation with our intelligent bus management system
                  </p>
                </div>
            ...
            <div className="bg-gradient-to-br from-slate-900/80 via-blue-950/60 to-indigo-950/70 backdrop-blur-lg p-6 md:p-8 lg:p-12 flex flex-col justify-center order-1 lg:order-2">
              <div className="max-w-md mx-auto w-full">
                <div className="text-center mb-8">
                  ...
                  <h1 className="text-2xl md:text-3xl font-bold text-white mb-3">Welcome Back</h1>
                  <p className="text-sky-200/70 text-sm md:text-base">
                    {mode === 'user' ? 'Access your personal travel dashboard' : 'Access conductor and admin panel'}
                  </p>
                </div>
                
                {/* Enhanced Mode Toggle */}
                <div className="flex gap-2 mb-8 bg-slate-800/60 rounded-xl p-1 border border-slate-700/50">
                  <button
                    onClick={() => handleModeChange('user')}
                    className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all duration-300 text-sm md:text-base ${
                      mode === 'user'
                ...
                <div className="mt-8 text-center space-y-4">
                  {mode === 'user' && (
                    <p className="text-slate-300 text-sm">
                      ...
                      <Link to="/register" className="text-sky-400 hover:text-sky-300 font-semibold underline transition-colors">
                        Create one here
                      </Link>
                    </p>
                  )}
                  ...
                  {mode === 'conductor' && (
                    <p className="text-slate-400 text-xs md:text-sm bg-slate-800/30 p-3 rounded-lg border border-slate-700/50">
                      🔐 Admin credentials will redirect to admin panel automatically
                    </p>
                  )}

                  {/* Additional Links */}
                  <div className="pt-4 border-t border-slate-700/50">
                    <button className="text-sky-300 hover:text-sky-200 text-sm transition-colors font-medium">
